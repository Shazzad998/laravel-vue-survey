<template>
  <div
    class="flex flex-col px-6 py-5 shadow-md bg-white hover:bg-gray-50 h-[470px]"
  >
    <img
    ...
    <div class="flex justify-between items-center mt-3">
      <router-link
        ...
        class="flex py-2 px-4 border border-transparent text-sm rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-50e"
      >
        <svg
